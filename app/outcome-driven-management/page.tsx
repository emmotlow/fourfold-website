    ...
    <>
      ...
      <section className="relative bg-navy-dark text-white overflow-hidden grain">
        ...
        <div className="max-w-6xl mx-auto px-6 py-28 md:py-40 relative z-10">
          <FadeIn>
            <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold leading-[0.95] tracking-tight mb-8 max-w-4xl">
          ...
          <FadeIn delay={150}>
            <p className="text-lg md:text-xl text-blue-200/70 max-w-2xl leading-relaxed">
              Outcome-Driven Management (ODM) is a framework that makes outcomes
              &mdash; not tasks or rules &mdash; the atomic unit of work. It
              replaces static, rule-driven processes with continuous, AI-powered
              measurement that aligns daily work with business results. ODM can
              be implemented in a week using your existing systems of record.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <article className="bg-white">
        ...
        <section className="py-24 md:py-32">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-lg text-slate-600 leading-relaxed space-y-6">
              <FadeIn>
                <p>
                  Modern organizations are flatter, faster, and more complex
                  than ever.
                </p>
              </FadeIn>
              <FadeIn delay={100}>
                <p>
                  ...
                  supervisory view. This creates dropped balls, inflated costs,
              ...
              <FadeIn delay={150}>
                <p>
                  ...
                  tools measure accountability within departments while
                  completely missing accountability toward organizational goals.
                  Engineering celebrates story points while sales misses revenue
                  targets.
                </p>
              </FadeIn>
              <FadeIn delay={200}>
                <p>
                  ...
                  invisible to management hierarchy, severing the connection
                  between daily work and end goals.
                </p>
              </FadeIn>
            </div>
          </div>
        ...
        <section className="py-24 md:py-32 bg-sand">
          <div className="max-w-3xl mx-auto px-6">
            <FadeIn>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-slate-900 mb-8 leading-tight">
                Rule-driven processes inherently introduce risk to achievement
                of valuable business results.
              </h2>
            </FadeIn>
            <FadeIn delay={100}>
              <p className="text-lg text-slate-600 leading-relaxed mb-8">
                Management&rsquo;s fundamental purpose is coordinating valuable
                business results. However, most organizations are failing at
                this basic function because they rely on static, rule-driven
                processes, which is compounded by the characteristics of the
                modern organization. The problem is two-fold:
              </p>
            </FadeIn>
            <div className="space-y-6">
              <FadeIn delay={200}>
                <div className="bg-white border-l-4 border-gold rounded-r-2xl p-6">
                  <p className="text-slate-700 leading-relaxed">
                    <strong className="text-slate-900">
                      1. Rule-driven processes detach tasks from the outcome
                      they&rsquo;re meant to achieve.
                    </strong>{" "}
                    They are often built around what mattered in the past and
                    not what actually matters today. Rule-driven processes were
                    designed for a slower, more predictable world. However,
                    technology advancements are driving us to work faster in
              ...
              <FadeIn delay={300}>
                <div className="bg-white border-l-4 border-gold rounded-r-2xl p-6">
                  <p className="text-slate-700 leading-relaxed">
                    ...
                    weekly or monthly reviews kills momentum, stalls innovation,
                    and reduces outcome success rates.
                  </p>
                </div>
              </FadeIn>
            </div>
          ...
          <div className="max-w-3xl mx-auto px-6">
            ...
            <FadeIn delay={100}>
              <p className="text-lg text-slate-600 leading-relaxed mb-12">
                ...
                closes key gaps in existing management frameworks and is
                designed to be continuous, fast, and cost-effective by aligning
                with the way people work in modern organizations. ODM can be
                implemented using existing systems of record and integrated with
                your data sets naturally.
              </p>
            </FadeIn>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                ...
                <FadeIn key={item.title} delay={200 + i * 100}>
                  <div className="bg-sand p-6 rounded-2xl border border-slate-200/80 h-full">
              ...
              <FadeIn delay={150}>
                <div className="bg-sand border-l-4 border-gold rounded-r-2xl p-6">
                  <p className="text-slate-700 leading-relaxed">
                    ...
                    unlike tasks, which can only be measured in volume, not
                    value. Must provide clear satisfaction conditions and
              ...
              <FadeIn delay={250}>
                <div className="bg-sand border-l-4 border-gold rounded-r-2xl p-6">
                  <p className="text-slate-700 leading-relaxed">
                    ...
                    party understands why something needs completion and can
            ...
            <FadeIn delay={300}>
              <div className="bg-navy-dark/5 border border-slate-200/80 rounded-2xl p-6">
                <p className="text-slate-700 leading-relaxed">
                  ...
                  Instead of measuring &ldquo;story points&rdquo; (output),
                  measure &ldquo;VP of Product approves the new feature
                  release&rdquo; (outcome).
                </p>
              </div>
            </FadeIn>
        ...
        <section className="py-24 md:py-32 bg-sand">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-lg text-slate-600 leading-relaxed space-y-6">
              <FadeIn>
                <p>
                  As AI radically alters how work gets done, executives, heads
                  of function, and business leads need visibility into their
                  most critical outcomes while adapting to rapidly changing
                  technology. Consistently defining and tracking outcomes has
                  historically been difficult, however, AI now defines outcomes
                  directly from existing data sources continuously. (see{" "}
                  <a
            ...
            <FadeIn delay={300}>
              <div className="mt-10 bg-navy-dark/5 border border-slate-200/80 rounded-2xl p-6">
                <p className="text-slate-700 leading-relaxed">
                  ...
                  salesperson is responsible for removing customer blockers but
                  has limited influence over internal stakeholders. Traditional
                  management tracks departmental metrics: sales stage, story
                  points delivered, legal hours billed. None of these predict the
                  actual outcome, which is deal closure. ODM focuses on the
        ...
        <section className="py-24 md:py-32 bg-sand">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-lg text-slate-600 leading-relaxed space-y-6">
              <FadeIn>
                <p>
                  ODM can be implemented in a week in small teams and then
                  scaled to handle huge organizations and even networks of
                  companies. By starting with a client&rsquo;s or
                  stakeholder&rsquo;s desired outcomes and working backward to
                  identify blockers (which are themselves outcomes), you can
                  create a clear path of action. Assign each person the biggest
                  outcomes they are likely to complete, communicate expected
                  dates, and track the success of each outcome.
                </p>
              </FadeIn>
              <FadeIn delay={100}>
                <p>
                  ...
                  ) to accelerate and scale ODM, you can quickly achieve much
                  higher levels of execution and transparency with a fraction of
                  the management overhead of traditional approaches.
                </p>
              </FadeIn>
            </div>
          </div>
